...
- [ ] Create `docker-compose.yml` with 5 services (postgres, redis, api, worker, web)
- [ ] Create `infra/Dockerfile.api` (Python 3.12 base)
- [ ] Create `infra/Dockerfile.worker` (Python 3.12 base)
