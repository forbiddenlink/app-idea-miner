...
class TextProcessor:
    ...
    def extract_need_statements(self, text: str, context_chars: int = 100) -> list[dict[str, str]]:
        """
        ...
        for sentence in sentences:
            for pattern in self.NEED_PATTERNS:
                ...
                for match in matches:
                    ...
                    # Extract context
                    context = self._extract_context(text, match.start(), match.end(), context_chars)
    ...
    def _extract_context(self, text: str, start: int, end: int, context_chars: int) -> str:
        """
    ...
    def extract_domain(self, text: str) -> str:
        ...
        domains = {
            ...
            "shopping": ["shopping", "buy", "purchase", "store", "product", "ecommerce", "retail"],
        }
