...
export const StatCardSkeleton = () => (
  <div className="bg-slate-800 rounded-lg shadow-lg p-6 animate-pulse">
    ...
    <div className="mt-4 h-3 bg-slate-700 rounded w-32"></div>
  </div>
);
  ...
  <div className="bg-slate-800 rounded-lg shadow-lg p-6 animate-pulse">
    <div className="space-y-4">
      ...
      <div className="flex gap-4 pt-4 border-t border-slate-700">
        ...
        <div className="space-y-1">
          <div className="h-3 bg-slate-700 rounded w-12"></div>
          <div className="h-5 bg-slate-700 rounded w-10"></div>
        </div>
      </div>
    </div>
  </div>
...
export const IdeaCardSkeleton = () => (
  <div className="bg-slate-800 rounded-lg shadow p-4 animate-pulse">
...
export const TableSkeleton = () => (
  <div className="bg-slate-800 rounded-lg shadow-lg overflow-hidden animate-pulse">
