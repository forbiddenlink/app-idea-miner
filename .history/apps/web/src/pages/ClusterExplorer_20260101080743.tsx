  ...
  return (
    <div className="max-w-7xl mx-auto">
      ...
      <div className="mb-8 flex items-start justify-between">
        ...
        <div className="flex items-center gap-3">
          <button
            ...
            className="group relative px-4 py-2 rounded-lg bg-slate-800/50 hover:bg-slate-700/50 border border-slate-700/50 transition-all duration-200 flex items-center gap-2"
          >
            <ArrowPathIcon className={`w-5 h-5 ${isRefreshing ? 'animate-spin' : 'group-hover:rotate-180 transition-transform duration-500'}`} />
            <span>Refresh</span>
          </button>
      ...
      <div className="flex gap-8">
        ...
        {/* Cluster Grid */}
        <div className="flex-1">          {/* Active Filter Chips */}
          <FilterChips chips={activeFilters} onClearAll={clearAllFilters} />          {/* Loading State */}
          {isLoading && (
