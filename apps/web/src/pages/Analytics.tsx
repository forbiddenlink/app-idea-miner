          ...
          {summaryLoading ? (
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
              ...
              <div className="card">
                ...
                <div
                  className={`text-3xl font-bold ${summary.overview.avg_sentiment >= 0.05
                    ? 'text-success-400'
                ...
                <div className="flex gap-2">
                  ...
                  <div className="flex bg-slate-700 rounded-lg p-1">
                    <button
                      ...
                      className={`px-3 py-1 rounded text-sm font-medium transition-colors ${trendMetric === 'ideas'
                    ...
                    <button
                      ...
                      className={`px-3 py-1 rounded text-sm font-medium transition-colors ${trendMetric === 'clusters'
                        ? 'bg-primary-500 text-white'
                        : 'text-slate-300 hover:text-white'
                        }`}
                    >
                  ...
                  <ResponsiveContainer width="100%" height={320}>
                    <BarChart data={domains}>
                      ...
                      <Tooltip
                        ...
                        labelStyle={{ color: '#e2e8f0' }}
                      />
                      <Bar dataKey="idea_count" fill={COLORS.primary} radius={[8, 8, 0, 0]} />
                    </BarChart>
                  </ResponsiveContainer>
                ) : (
                  <div className="h-80 flex items-center justify-center text-slate-400">
                  ...
                  <tbody>
                    {domains.map((domain: DomainStats, index: number) => (
                      <tr key={index} className="border-b border-slate-700/50 hover:bg-slate-700/30">
                        ...
                        <td className="py-3 px-4 text-slate-300">{domain.idea_count}</td>
                        <td className="py-3 px-4 text-slate-300">
                          {domain.percentage?.toFixed(1)}%
                        </td>
                        <td className="py-3 px-4">
                          <span
                            className={`px-2 py-1 rounded text-sm font-medium ${domain.avg_sentiment >= 0.05
